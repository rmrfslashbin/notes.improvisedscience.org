...
4. **Add quick-cooking vegetables**: Add bok choy stems and kimchi (if using). Simmer for 3-4 minutes until bok choy stems begin to soften. If using tofu, add it now and simmer gently for 2 minutes.

5. **Finish**: Add bok choy leaves in the last minute—they'll wilt quickly. Taste the broth and adjust:
   - More doenjang for deeper savoriness
   - More gochugaru for heat
   - More soy sauce for saltiness
   - Splash of rice vinegar for brightness (optional)
...
- **Doenjang vs miso**: While related, doenjang is chunkier, funkier, and more intensely flavored than Japanese miso. Don't substitute miso 1:1—it won't give you the same depth. If you must substitute, use red/dark miso and increase the amount slightly.

- **Gochugaru substitute**: Korean chili flakes (gochugaru) have a unique fruity, slightly smoky flavor. Aleppo pepper is the closest substitute, followed by Turkish or Kashmiri chili flakes. Avoid cayenne—it's too sharp.

- **White beans work beautifully**: While non-traditional, white kidney beans absorb the broth's flavors and provide creamy texture and protein. They're heartier than tofu and make this a more substantial meal.

- **Kimchi addition**: Adding kimchi to the stew is common in Korean cooking. It adds another layer of fermented funk, acidity, and spice. Use well-fermented (sour) kimchi for best results.

- **Adjust thickness**: For a brothier jjigae, add more stock. For thicker, stew-like consistency, let it simmer longer to reduce. Traditionally it's somewhere in between—spoonable but not thick.

- **Rice is essential**: Jjigae is always served with rice. The rice balances the intense, salty, funky flavors of the stew. You eat spoonfuls of stew between bites of rice.
...
- **Seafood version**: Add clams, mussels, or shrimp in the last 5 minutes (no longer vegan).

- **Spicy boost**: Add 1-2 tablespoons gochujang (Korean chili paste) along with the doenjang for extra heat and sweetness.
