...
categories: ["Main"]
tags: ["Indian", "Gujarati", "Dal", "Lentils", "Peanuts", "Main Course", "Side Dish", "Vegetarian", "Gluten-Free", "Dairy-Free"]
methods: ["Stove-Top"]
...
## Ingredients
- 360ml (1½ cups) yellow toor lentils
- 2 star anise
- canola oil
...
- 60ml (¼ cup) red-skinned peanuts, crushed
...
3. When the lentils are cooked, whisk them to thicken, then add the tempering. The mixture will be quite thick, and Gujarati dal is normally thin, so add at least 180ml (¾ cup) of hot water (or as you prefer), then simmer for a further 15 minutes. Check that the salt, lemon, chile, and honey are to your liking, then take off the heat.
