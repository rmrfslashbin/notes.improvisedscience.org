...
draft: false
description: "A rustic savory pie of caramelized onions, leeks, and herb-roasted mushrooms bound with egg, parmesan, and oat milk in a buttery pâte brisée shell."
categories: ["Main"]
tags:
    - mushrooms
    - leeks
...
## Notes
- This recipe requries one pie shell (half a recipe) of [Pâte Brisée]({{< ref "/recipes/pate-brisee" >}} "Pâte Brisée").
...
## Ingredients
- 770g (28oz) trimmed and cleaned oyster and other mixed mushrooms
...
- 3 to 4 Thyme sprigs
- 2 large eggs
- 80ml (⅓ cup) oat or other milk
- 145 grams (5 oz) finely grated parmesan cheese
- 1 pie shell from [Pâte Brisée]({{< ref "/recipes/pate-brisee" >}} "Pâte Brisée")
...
2. To the onion/leek/mushroom mixture, add eggs, milk, and cheese; stir to incorporate.
3. Pour mixture over prepared pie crust.
4. Bake 35 to 40 minutes until top is lightly browned. Let cool. Serve with balsamic vinegar and fresh herbs.
