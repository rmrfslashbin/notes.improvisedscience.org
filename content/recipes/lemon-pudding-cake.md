...
1.  Place a large roasting pan on a rack in the center of the oven. Fill
...
3.  In another bowl, stir together:
    ...
    -   flour
    -   salt
4.  Whisk **half the flour mixture** into the egg yolks, then half the
    **milk**.
5.  Whisk in remaining **flour mixture**, then remaining **milk**.
6.  Whip the **egg whites** until soft peaks form, then gently fold them
    into the batter.
