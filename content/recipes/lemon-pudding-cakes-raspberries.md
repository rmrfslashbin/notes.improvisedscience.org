...
-   200g (7oz) granulated sugar; divided into two: 3/4 cup and the
    remaining
...
3.  Place ramekins in a 9x13x2" baking dish; evenly spaced without
...
2.  Using a rubber spatula, fold whites into base until only a few white
    streaks remain.
...
3.  Fill the baking disk with hot water, half way up the sides of the
    ramekins.
4.  Bake 35 to 40 minutes. until puddings are puffed and lightly
    browned.

### Cool

1.  Carefully remove baking disk from oven.
2.  Remove ramekins from baking dish (use rubberized tongs and spatula
    to assist).
3.  Place ramekins on a wire cooling rack and let cool to room
    temperature.
